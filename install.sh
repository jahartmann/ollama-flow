...
# ETL Automation Expert - Installation Script
# This script sets up the development environment for the ETL application

set -e

echo "🚀 ETL Automation Expert - Installation Script"
echo "=============================================="
...
create_env() {
    ...
    if [ ! -f ".env.local" ]; then
        cat > .env.local << EOF
# ETL Automation Expert Environment Configuration
